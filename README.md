 ...
 <div>
  ...
  <div>
     <ul class="ul1 ul2">
       ...
       <li class="li1"><a href="#" class="li2">CỰU SINH VIÊN</a>
        <div class="drop1">
         <a href="#">Cộng đồng cựu sinh viên</a>
         <a href="#">Họ đang làm việc tại đâu</a>
        </div></li>     
       <li class="li1"><a href="#" class="li2">TUYỂN SINH</a></li>
       <li class="li1"><a href="#" class="li2">LIÊN HỆ</a></li>
     </ul>
  </div>
 </header>
<div class="slideshow-container">
  <div class="mySlides1">
    <img src="http://daihoc.fpt.edu.vn/media/2018/08/TRAICUU-T8-01.jpg" style="width:100%; height:650px;">
  </div>

  <div class="mySlides1">
    <img src="http://daihoc.fpt.edu.vn/media/2016/11/FUG-t3-2018-bannerweb.jpg" style="width:100%; height:650px;">
  </div>
...
<div class="container">
 <div> 
  <h1 class="hnew"><b>ĐĂNG KÝ NGÀNH HỌC PHÙ HỢP VỚI BẠN</b></h1>
 </div>
 <div class="row">
  <div class="col-sm-4" style="padding: 20px;">
    <a href="#"><img src="https://i.imgur.com/ntseNKu.jpg" alt="BÁO CHÍ & TRUYỀN THÔNG" class="col-img"></a><br>
    <p class="col-text text-center"><a href="#" class="col-text">BÁO CHÍ & TRUYỀN THÔNG</a></p>
  </div>
  <div class="col-sm-4" style="padding: 20px;">
    <a href="#"><img src="https://i.imgur.com/B2Exwj1.png" alt="NGÔN NGỮ" class="col-img"></a><br>
    <p class="col-text text-center"><a href="#" class="col-text">NGÔN NGỮ</a></p>
  </div>
  <div class="col-sm-4" style="padding: 20px;">
    <a href="#"><img src="https://i.imgur.com/xT1Tl8E.jpg" alt="KINH DOANH & QUẢN LÝ" class="col-img"></a><br>
    <p class="col-text text-center"><a href="#" class="col-text">KINH DOANH & QUẢN LÝ</a></p>
  </div>
 </div>
...
Email: <a href="mailto:daihoc.hcm@fpt.edu.vn">daihoc.hcm@fpt.edu.vn</a></p>
   </div>
   <div class="col-sm-3">
